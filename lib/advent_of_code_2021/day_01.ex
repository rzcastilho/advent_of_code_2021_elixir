defmodule AdventOfCode2021.Day01 do
  ...
  @input File.read!("data/day01.txt")

  @doc """
  It runs the first part of the puzzle.

  The answer must be 1139.

      iex> AdventOfCode2021.Day01.part1()
      1139
  """
  def part1() do
    transform_data()
  ...
  The answer must be 1103.

      iex> AdventOfCode2021.Day01.part2()
      1103
  """
  def part2() do
    transform_data()
  ...
  defp compare(number, [next | rest], acc) when next > number, do: compare(next, rest, acc + 1)
