defmodule AdventOfCode2021.Day02 do
  ...
  @doc """
  It runs the first part of the puzzle.

  The answer must be 1714950.

      iex> AdventOfCode2021.Day02.part1()
      1714950
  """
  def part1() do
    {horizontal_position, depth} = Enum.reduce(transform_data(), {0, 0}, &command/2)
    horizontal_position * depth
  end

  @doc """
  It runs the second part of the puzzle.

  The answer must be 1281977850.

      iex> AdventOfCode2021.Day02.part2()
      1281977850
  """
  def part2() do
    {horizontal_position, depth, _aim} = Enum.reduce(transform_data(), {0, 0, 0}, &command/2)
    horizontal_position * depth
  end
